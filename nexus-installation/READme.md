...
```sh
sudo wget http://download.sonatype.com/nexus/3/nexus-3.68.1-01-unix.tar.gz 
sudo tar -zxvf nexus-3.68.1-01-unix.tar.gz
sudo mv /opt/nexus-3.68.1-01 /opt/nexus
```
